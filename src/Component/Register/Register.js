        ...
        <div>
            <div style={{ marginTop: "50px" }} className='d-flex justify-content-center'>
                <form>
                    ...
                    <input className='my-2 py-2 login-field' type="email" name="email" id="" placeholder='Enter Your Email' required /> <br />
                    <input className='my-2 py-2 login-field' type="password" name="password" id="" placeholder='Enter Your Password' required /><br />
                    <input className='my-2 py-2 login-field' type="password" name="confirmPassword" id="" placeholder='Enter The Same Password' required /><br />
